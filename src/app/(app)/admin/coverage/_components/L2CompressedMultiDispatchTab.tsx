...
export function L2CompressedMultiDispatchTab() {
  ...
  return (
    <div className="space-y-5 max-w-4xl">
      ...
      <div className="rounded-md border border-hair bg-secondary px-4 py-3">
        <p className="text-[13px] text-ink font-medium">On-demand L2.5 (Compressed) skill dispatch</p>
        <p className="text-[12px] text-ink-3 mt-1">
          Runs a compressed skill against the chosen ticker set. Preview checks if each ticker has the required base L2 coverage.
        </p>
      </div>
