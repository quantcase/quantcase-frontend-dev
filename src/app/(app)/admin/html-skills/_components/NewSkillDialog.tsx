...
export function NewSkillDialog({ open, creating, error, onClose, onCreate }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="w-[520px] rounded-[10px] border border-[var(--qc-border-default)] bg-card shadow-xl">
        <div className="flex items-center justify-between border-b border-[var(--qc-border-default)] px-5 py-4">
          ...
          <button onClick={handleClose} className="text-ink-3 hover:text-[var(--qc-ink)] transition-colors">
            <X className="size-4" />
          </button>
        </div>
        ...
        <div className="flex justify-end gap-2 border-t border-[var(--qc-border-default)] px-5 py-3">
          <button
            onClick={handleClose}
            className="rounded-md border border-[var(--qc-border-default)] px-4 py-1.5 text-[12px] font-medium text-ink-3 hover:text-[var(--qc-ink)] transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            className="flex items-center gap-1.5 rounded-md bg-ink px-4 py-1.5 text-[12px] font-medium text-[var(--qc-on-dark)] hover:opacity-90 transition-opacity disabled:opacity-40"
          >
