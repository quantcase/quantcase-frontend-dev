...
export default function PostHtmlSkillsPage() {
  ...
  return (
    <div className={`p-6 space-y-5 ${tab === "Configs" ? "" : "max-w-4xl"}`}>
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-[14px] text-[var(--qc-ink-2)] mt-0.5">
            On-demand L3 (management / opportunity / deal) and L4 (summary) analysis — dispatch runs and
            edit prompts/schemas per type.
          </p>
        </div>
