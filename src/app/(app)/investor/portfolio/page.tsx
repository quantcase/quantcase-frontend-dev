...
const TABS: { id: Tab; label: string; shortLabel?: string; badgeFn?: (withThesis: number, total: number, newsCount: number) => string | undefined }[] = [
  { id: "holdings", label: "Equity Holdings",    shortLabel: "Holdings" },
  { id: "mf",       label: "Mutual Funds",        shortLabel: "MF" },
  { id: "news",     label: "News & MOD Impact",   shortLabel: "News", badgeFn: (_wt, _t, n) => `${n} new` },
  { id: "sector",   label: "Sector Overlay",      shortLabel: "Sector" },
  { id: "journal",  label: "📓 Investment Journal", shortLabel: "📓 Journal", badgeFn: (wt, t) => `${wt}/${t}` },
];
