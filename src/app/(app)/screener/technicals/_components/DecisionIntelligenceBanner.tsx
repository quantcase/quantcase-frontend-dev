          ...
          {showTooltip && (
            ...
            >
              <div style={{
                ...
                <span style={{ fontSize: "var(--qc-fz-12)", fontWeight: "var(--qc-w-semi)", color: "var(--qc-ink)", fontFamily: "var(--qc-font-sans)" }}>{indicator.name}</span>
                <span style={{ fontSize: "var(--qc-fz-11)", fontWeight: "var(--qc-w-semi)", color: sc.color, fontFamily: "var(--qc-font-sans)" }}>{indicator.tag}</span>
              </div>
              <div style={{ padding: "10px 12px", display: "flex", flexDirection: "column", gap: 6 }}>
                ...
                {watchout && (
                  <p style={{ margin: 0, fontSize: "var(--qc-fz-11)", color: "var(--qc-ink-2)", lineHeight: 1.45, fontFamily: "var(--qc-font-sans)" }}>
                    <span style={{ fontWeight: "var(--qc-w-semi)" }}>Watchout: </span>{watchout}
                  </p>
                )}
              </div>
            </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 1, padding: "14px 16px", display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
            <div>
              <p style={{ margin: 0, fontSize: "var(--qc-fz-16)", fontWeight: "var(--qc-w-semi)", color: "var(--qc-ink)", lineHeight: 1.3, fontFamily: "var(--qc-font-sans)" }}>
                {di.tag}
              </p>
            </div>
          </div>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={item.label} style={{
                ...
                <p style={{
                  margin: 0, fontFamily: "var(--qc-font-mono)", fontSize: "var(--qc-fz-9)",
                  color: "var(--qc-ink-2)", textTransform: "uppercase" as const,
                  letterSpacing: ".1em", marginBottom: 3,
                }}>
                  {item.label}
                </p>
                <p style={{ margin: 0, fontSize: "var(--qc-fz-11)", fontWeight: "var(--qc-w-semi)", color: "var(--qc-ink)", lineHeight: 1.3, fontFamily: "var(--qc-font-sans)" }}>
                  {item.value}
                </p>
              </div>
            ))}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <div style={{
              ...
              letterSpacing: "var(--qc-track-eyebrow-l)", color: "var(--qc-ink-2)", textTransform: "uppercase" as const,
            }}>
              Actionable Insight
            </div>
            <p style={{ margin: 0, fontSize: "var(--qc-fz-14)", fontWeight: "var(--qc-w-medium)", color: "var(--qc-ink)", lineHeight: 1.45, letterSpacing: "-0.005em", fontFamily: "var(--qc-font-sans)" }}>
            ...
            <>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                ...
                {di.actionableInsight.reEvaluateCondition && (
                  <p style={{ margin: 0, fontSize: "var(--qc-fz-11)", color: "var(--qc-ink-2)", lineHeight: 1.5, fontFamily: "var(--qc-font-sans)" }}>
      ...
      <div style={{
        ...
        <div style={{ borderTop: "1px solid var(--qc-hair)", paddingTop: 10, display: "flex", flexDirection: "column", gap: 6 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <span style={{ fontSize: "var(--qc-fz-11)", fontWeight: "var(--qc-w-semi)", color: conviction.color, fontFamily: "var(--qc-font-sans)" }}>{di.convictionLevel}</span>
          </div>
      ...
      {di.currentRegime && (
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: "var(--qc-fz-13)", fontWeight: "var(--qc-w-semi)", color: "var(--qc-ink)", lineHeight: 1.3, fontFamily: "var(--qc-font-sans)" }}>
