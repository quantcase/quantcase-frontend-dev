  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "5px 0", cursor: "default" }}>
        ...
        <span style={{ fontSize: 12, color: "var(--qc-text-body)", width: 130, flexShrink: 0, lineHeight: 1.2 }}>{item.label}</span>
      ...
      {open && item.details.length > 0 && (
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: 13, fontWeight: 600, color: "var(--qc-text-heading)" }}>{item.label}</span>
    ...
    <div style={{ display: "flex", flexDirection: "column" }}>
      {items.map((item, i) => (
        <div key={i} style={{
          ...
          <div style={{ minWidth: 0 }}>
            <span style={{ fontSize: 12, fontWeight: 600, color: "var(--qc-text-heading)", lineHeight: 1.4, display: "block" }}>
              {item.title}
            </span>
            <p style={{ margin: "2px 0 0", fontSize: 11, color: "var(--qc-text-body)", lineHeight: 1.5 }}>
              {item.description}
            </p>
          </div>
        </div>
