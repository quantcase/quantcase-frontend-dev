    ...
    <div className="rounded-[10px] border border-[#E2E2E2] bg-[#F5F5F5] p-2">
      <div className="rounded-[10px] bg-white p-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span style={{ fontSize: 14, fontWeight: 600, color: "#0F172B" }}>Client Context</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={label}>
              <div style={{ fontSize: 11, color: "#888888", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 4 }}>
                {label}
              </div>
              <div style={{ fontSize: 15, fontWeight: 500, color: "#0F172B" }}>{value}</div>
            </div>
          ))}
        </div>
      </div>
