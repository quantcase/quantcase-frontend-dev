      ...
      <div className="rounded-[10px] bg-white p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={label}>
              <div style={{ fontSize: 11, color: "var(--qc-ink-2)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 4 }}>
                {label}
              </div>
              <div style={{ fontSize: 15, fontWeight: 500, color: "var(--qc-ink)" }}>{value}</div>
            </div>
          ))}
        </div>
      </div>
