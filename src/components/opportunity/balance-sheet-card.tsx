    ...
    <div className="space-y-4">
        ...
        {showDetails && (
          <div className="rounded-lg border border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800/40 p-4 space-y-3">
            <span className="text-xs font-semibold uppercase tracking-wider text-zinc-500">⊙ Balance Sheet Assessment</span>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2.5">
                <p className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Considerations</p>
