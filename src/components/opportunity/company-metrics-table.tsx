...
function changeColor(val: CellValue): string {
  if (val === null || val === undefined) return "#888888";
...
function sentimentBadge(sentiment: string | null | undefined) {
  if (!sentiment || sentiment === "—") return <span style={{ color: "#888888" }}>—</span>;
              ...
              >
                ...
                <td
                  style={{
                    ...
                    color: row.is_current ? "#0F172B" : "#121212",
                    position: "sticky",
                    left: 0,
                ...
                >
                  ...
                  {row.is_current && (
                    <span
                      ...
                      style={{ color: "#0F172B", backgroundColor: "rgba(15,23,43,0.08)" }}
                    >
                      YOU
                    </span>
                  )}
