...
const metricTileStyles = [
  { labelColor: "text-indigo-500", valueColor: "text-zinc-900 dark:text-zinc-50", sublabelColor: "text-zinc-500 dark:text-zinc-400", bg: "bg-white dark:bg-zinc-900" },
  { labelColor: "text-blue-500", valueColor: "text-blue-700 dark:text-blue-300", sublabelColor: "text-zinc-500 dark:text-zinc-400", bg: "bg-white dark:bg-zinc-900" },
  { labelColor: "text-emerald-600", valueColor: "text-emerald-700 dark:text-emerald-300", sublabelColor: "text-zinc-500 dark:text-zinc-400", bg: "bg-white dark:bg-zinc-900" },
  { labelColor: "text-purple-500", valueColor: "text-purple-700 dark:text-purple-300", sublabelColor: "text-zinc-500 dark:text-zinc-400", bg: "bg-white dark:bg-zinc-900" },
  { labelColor: "text-orange-500", valueColor: "text-orange-700 dark:text-orange-300", sublabelColor: "text-zinc-500 dark:text-zinc-400", bg: "bg-white dark:bg-zinc-900" },
  { labelColor: "text-zinc-500", valueColor: "text-zinc-900 dark:text-zinc-50", sublabelColor: "text-zinc-500 dark:text-zinc-400", bg: "bg-white dark:bg-zinc-900" },
];
    ...
    <div className="space-y-4">
            ...
            return (
              <div key={i} className={`rounded-lg border border-zinc-100 dark:border-zinc-800 p-3 ${metric.style.bg}`}>
                ...
                <div className="flex items-baseline gap-2">
                  <p className={`text-2xl font-bold ${metric.style.valueColor}`}>{metric.value}</p>
                  {metric.change && (
        ...
        {data?.text?.takeaway && (
          <div className="border-t border-blue-100 dark:border-blue-900/50 bg-blue-50 dark:bg-blue-900/20 -mx-6 px-6 py-3 rounded-b-lg">
            <p className="text-xs font-bold text-blue-700 dark:text-blue-400 uppercase tracking-wide mb-1">MARKET TAKEAWAY</p>
            <p className="text-xs text-zinc-700 dark:text-zinc-300 leading-relaxed">{data.text.takeaway}</p>
          </div>
        )}
    </div>
  );
