    ...
    >
      ...
      >
        ...
        <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
          <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: "0.16em", color: "var(--qc-ink-2)", textTransform: "uppercase" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", alignItems: "center", gap: 16, padding: "4px 0 10px" }}>
          {/* legend */}
          <div style={{ display: "flex", flexWrap: "wrap", gap: 14, fontSize: 12.5, color: "var(--qc-ink-2)" }}>
          ...
          <div style={{ textAlign: "center", padding: "0 24px" }}>
            <div style={{ fontSize: 52, fontWeight: 500, letterSpacing: "-0.035em", color: "var(--qc-ink)", lineHeight: 1, fontVariantNumeric: "tabular-nums" }}>
              {score !== null ? displayScore : "—"}
              <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 16, color: "var(--qc-ink-2)", letterSpacing: 0, fontWeight: 400, marginLeft: 3 }}>/100</span>
            </div>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10.5, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--qc-ink-2)", marginTop: 8 }}>
              {displayRating}
            </div>
          </div>
            ...
            {(["Score", "vs Sector", "vs Nifty"] as PeriodTab[]).map((tab) => (
              <button
                ...
                style={{
                  ...
                  border: 0,
                  borderBottom: activeTab === tab ? "1.5px solid var(--qc-ink)" : "1.5px solid transparent",
                  padding: activeTab === tab ? "6px 10px 4px" : "6px 10px",
                  fontFamily: "inherit",
                  fontSize: 12,
                  fontWeight: 500,
                  color: activeTab === tab ? "var(--qc-ink)" : "var(--qc-ink-2)",
        ...
        <div style={{ position: "relative", margin: "0 -4px" }}>
          <svg viewBox="0 0 920 240" width="100%" height="240" preserveAspectRatio="none">
            ...
            <rect x="0" y="50" width="920" height="60" fill="var(--qc-section)" opacity=".4" />
            <rect x="0" y="170" width="920" height="70" fill="var(--qc-down-soft)" opacity=".35" />
            {/* dashed threshold lines */}
            <g stroke="var(--qc-hair)" strokeWidth="1">
            ...
            <path d="M0,112 C80,108 160,104 240,100 C320,95 400,90 480,88 C560,86 640,85 720,84 C800,83 880,82 920,82"
              fill="none" stroke="var(--qc-hair)" strokeWidth="1.6" strokeDasharray="5 4" />
            ...
            <path
              ...
              fill="none" stroke="var(--qc-ink)" strokeWidth="2.2" strokeLinejoin="round"
            />
            {/* endpoint dot */}
            <circle cx="920" cy={scoreY + 28} r="5" fill="var(--qc-ink)" />
            <circle cx="920" cy={scoreY + 28} r="9" fill="none" stroke="var(--qc-ink)" strokeOpacity=".18" strokeWidth="2" />
            {/* band labels */}
          ...
          {annotVisible && score !== null && (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, fontWeight: 600, padding: "3px 7px", borderRadius: 5, background: "var(--qc-ink)", color: "var(--qc-on-dark)", letterSpacing: "0.04em" }}>
                  {displayRating}
                </span>
                <button
                  onClick={() => setAnnotVisible(false)}
                  style={{ marginLeft: "auto", width: 18, height: 18, border: 0, background: "transparent", color: "var(--qc-ink-2)", fontSize: 14, cursor: "pointer", lineHeight: 1, padding: 0 }}
                >×</button>
              </div>
              <div style={{ fontSize: 11.5, color: "var(--qc-ink-2)", marginTop: 4, lineHeight: 1.35 }}>
                {mqiLabel ? `${mqiLabel} management quality` : "Combined M · O · D score"}
              </div>
              <div style={{ marginTop: 8, height: 3, background: "var(--qc-hair)", borderRadius: 999, position: "relative" }}>
                <span style={{ position: "absolute", left: "20%", right: "40%", top: 0, bottom: 0, background: "var(--qc-ink)", borderRadius: 999 }} />
              </div>
            </div>
          )}

          {/* x-axis */}
          <div style={{ display: "flex", justifyContent: "space-between", fontFamily: "'IBM Plex Mono', monospace", fontSize: 10.5, color: "var(--qc-ink-2)", letterSpacing: "0.08em", textTransform: "uppercase", padding: "6px 4px 0" }}>
      ...
      <aside
        style={{
          background: "linear-gradient(175deg, var(--qc-section) 0%, var(--qc-section) 100%)",
          border: "1px solid var(--qc-hair)",
          borderRadius: 18,
          padding: "18px 20px",
          display: "flex",
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
          <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: "0.16em", color: "var(--qc-ink-2)", textTransform: "uppercase" }}>
            Investment Thesis
          </span>
          <div style={{ display: "flex", gap: 4 }}>
            {[
              ...
              <button key={i} style={{ width: 24, height: 24, borderRadius: "50%", border: "1px solid var(--qc-hair-2)", background: "var(--qc-card)", color: "var(--qc-ink)", display: "grid", placeItems: "center", cursor: "pointer" }}>
                {icon}
              </button>
            ))}
          </div>
        ...
        {/* title */}
        <h3 style={{ margin: "2px 0 8px", fontSize: 18, fontWeight: 500, lineHeight: 1.35, letterSpacing: "-0.01em", color: "var(--qc-ink)", paddingRight: 20 }}>
          {headline}
        </h3>
          ...
          <svg viewBox="0 0 360 140" width="100%" height="140" preserveAspectRatio="none">
            <defs>
              <linearGradient id="qc-insight-fill" x1="0" x2="0" y1="0" y2="1">
                <stop offset="0%" stopColor="var(--qc-ink)" stopOpacity=".35" />
                <stop offset="100%" stopColor="var(--qc-ink)" stopOpacity="0" />
              </linearGradient>
            </defs>
            <g stroke="var(--qc-hair)" strokeWidth="1.4" opacity=".6">
            ...
            <path d="M0,85 C50,80 100,75 150,70 C200,65 260,55 320,40 L360,30" fill="none" stroke="var(--qc-ink)" strokeWidth="2" />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", alignItems: "center", gap: 12, marginTop: 6 }}>
          <div>
            <div style={{ fontSize: 26, fontWeight: 500, letterSpacing: "-0.02em", color: "var(--qc-ink)", lineHeight: 1, fontVariantNumeric: "tabular-nums" }}>
              {score !== null ? displayScore : "—"}<span style={{ fontSize: 16, marginLeft: 1 }}>/100</span>
            </div>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, color: "var(--qc-ink-2)", letterSpacing: "0.08em", textTransform: "uppercase", marginTop: 6 }}>
              QC · Score
            </div>
          </div>
          <button style={{ width: 38, height: 38, borderRadius: "50%", border: "1px solid var(--qc-hair-2)", background: "var(--qc-card)", color: "var(--qc-ink)", display: "grid", placeItems: "center", cursor: "pointer" }}>
          ...
          <div style={{ textAlign: "right" }}>
            <div style={{ fontSize: 26, fontWeight: 500, letterSpacing: "-0.02em", color: "var(--qc-ink)", lineHeight: 1 }}>
              {mqiLabel ?? displayRating}
            </div>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, color: "var(--qc-ink-2)", letterSpacing: "0.08em", textTransform: "uppercase", marginTop: 6, textAlign: "right" }}>
              Rating
            </div>
          </div>
        </div>
