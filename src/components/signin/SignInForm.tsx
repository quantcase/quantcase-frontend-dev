...
export function SignInForm() {
  ...
  return (
    <div className="w-full max-w-[360px]">
      ...
      <p style={{ fontSize: 12, color: "rgba(18,18,18,0.35)", marginTop: 32, textAlign: "center", lineHeight: 1.6 }}>
        Access is by invitation only. Contact your administrator<br />if you need an account.
      </p>
    </div>
  );
}
